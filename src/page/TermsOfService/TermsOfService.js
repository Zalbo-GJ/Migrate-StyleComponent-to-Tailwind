  ...
  return (
    <div className=" w-[90%]  max-w-[800px] justify-center text-darkGray box-border flex flex-col md:my-[100px] mx-auto mb-24 md:mb-0">
      ...
      <p className=" my-[1em]">
        ...
        <a className="text-blue-200/10" href="">
          CLAUSOLA SUGLI ARBITRATI
        </a>{" "}
        RIPORTATA PIÙ AVANTI. SALVO CHE PER DETERMINATI TIPI DI CONTROVERSIE
        CITATI IN TALE CLAUSOLA SUGLI ARBITRATI, TU E SNAP INC. ACCETTATE CHE
        OGNI CONTROVERSIA TRA LE PARTI SARÀ TRATTATA MEDIANTE ARBITRATO
        OBBLIGATORIO E VINCOLANTE E TU E SNAP INC. RINUNCIATE AD OGNI DIRITTO A
        PARTECIPARE A CLASS-ACTION O ARBITRATI COLLETTIVI.
      </p>
      <h3 className=" text-[24px] font-semibold mt-6 mb-[10px]">
